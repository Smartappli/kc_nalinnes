...
<head>
  ...
  <link rel="canonical" href="https://www.kc-nalinnes.be/dojo-kun.html" />

  <!-- Open Graph -->
  <meta property="og:title" content="Dojo Kun — KC Nalinnes" />
  <meta property="og:description" content="Le Dojo Kun (code de conduite) du karaté Shotokan : 5 préceptes, traduction, sens et conseils pour le réciter au dojo." />
  <meta property="og:type" content="website" />
  <meta property="og:url" content="https://www.kc-nalinnes.be/dojo-kun.html" />
  ...
  <meta name="twitter:title" content="Dojo Kun — KC Nalinnes" />
  <meta name="twitter:description" content="Le Dojo Kun (code de conduite) du karaté Shotokan : 5 préceptes, traduction, sens et conseils pour le réciter au dojo." />
...
<body class="bg-slate-950 text-slate-100">
  ...
  <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 pt-20 md:pt-24">
    ...
    <p class="text-sm text-slate-400 mb-8">
      Le « code de conduite du dojo » : 5 préceptes pour guider la pratique du karaté Shotokan… et le quotidien.
    </p>

    <!-- 1. C’est quoi ? -->
    <section id="definition" class="mb-10">
      <h2 class="text-2xl font-bold mb-3">1. C’est quoi le Dojo Kun&nbsp;?</h2>
      <p class="mb-3 text-slate-100/90">
        Le <strong>Dojo Kun</strong> est une courte liste de principes, généralement récités au début ou à la fin d’un entraînement.
        Ce n’est ni un “serment” ni une formule magique&nbsp;: c’est un rappel simple des valeurs que l’on veut cultiver
        sur le tatami (et en dehors).
      </p>
      <p class="mb-3 text-slate-100/90">
        En Shotokan, on retrouve le plus souvent cinq préceptes. L’ordre peut légèrement varier selon les dojos,
        mais l’esprit reste le même.
      </p>
    </section>

    <!-- 2. Les 5 préceptes -->
    <section id="preceptes" class="mb-10">
      <h2 class="text-2xl font-bold mb-4">2. Les 5 préceptes (Shotokan)</h2>

      <div class="grid md:grid-cols-2 gap-4">

        <div class="rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
          <p class="text-sm text-slate-400 mb-2">一、人格完成に努むること</p>
          <h3 class="text-lg font-bold">Jinkaku kansei ni tsutomuru koto</h3>
          <p class="mt-2 text-slate-100/90"><strong>Chercher la perfection du caractère.</strong></p>
          <p class="mt-2 text-sm text-slate-100/80">
            Progresser, se corriger, devenir plus posé, plus juste, plus fiable.
          </p>
        </div>

        <div class="rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
          <p class="text-sm text-slate-400 mb-2">一、誠の道を守ること</p>
          <h3 class="text-lg font-bold">Makoto no michi o mamoru koto</h3>
          <p class="mt-2 text-slate-100/90"><strong>Être sincère / suivre la voie de la vérité.</strong></p>
          <p class="mt-2 text-sm text-slate-100/80">
            Dire ce qu’on fait, faire ce qu’on dit, être honnête avec soi-même.
          </p>
        </div>

        <div class="rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
          <p class="text-sm text-slate-400 mb-2">一、努力の精神を養うこと</p>
          <h3 class="text-lg font-bold">Doryoku no seishin o yashinau koto</h3>
          <p class="mt-2 text-slate-100/90"><strong>Cultiver l’esprit d’effort.</strong></p>
          <p class="mt-2 text-sm text-slate-100/80">
            La régularité bat le “coup de motivation”&nbsp;: on avance séance après séance.
          </p>
        </div>

        <div class="rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
          <p class="text-sm text-slate-400 mb-2">一、礼儀を重んずること</p>
          <h3 class="text-lg font-bold">Reigi o omonzuru koto</h3>
          <p class="mt-2 text-slate-100/90"><strong>Respecter les autres (l’étiquette).</strong></p>
          <p class="mt-2 text-sm text-slate-100/80">
            Saluer, écouter, contrôler sa puissance, aider les plus jeunes et les débutants.
          </p>
        </div>

        <div class="rounded-2xl border border-slate-800 bg-slate-900/60 p-5 md:col-span-2">
          <p class="text-sm text-slate-400 mb-2">一、血気の勇を戒むること</p>
          <h3 class="text-lg font-bold">Kekki no yū o imashimuru koto</h3>
          <p class="mt-2 text-slate-100/90"><strong>Maîtriser l’agressivité / éviter la violence impulsive.</strong></p>
          <p class="mt-2 text-sm text-slate-100/80">
            Être courageux, oui — mais sans colère&nbsp;: garder le contrôle, même quand ça chauffe.
          </p>
        </div>
      ...
      <p class="mt-4 text-slate-100/80">
        Astuce : dans beaucoup de dojos, on commence chaque ligne par <strong>“Hitotsu”</strong> («&nbsp;premièrement / un&nbsp;»),
        pour marquer le rythme et l’importance de chaque point.
      </p>
    </section>

    <!-- 3. Comment le réciter -->
    <section id="recitation" class="mb-10">
      <h2 class="text-2xl font-bold mb-3">3. Comment le réciter au dojo&nbsp;?</h2>
      <ul class="list-disc pl-6 space-y-2 text-slate-100/90">
        <li>On se met en place, on se calme (respiration), puis on récite d’une voix claire, ensemble.</li>
        <li>Le Dojo Kun se récite souvent à la fin, juste avant les saluts, quand l’attention est maximale.</li>
        <li>Le but n’est pas de “parler japonais” parfaitement, mais de comprendre ce que l’on répète.</li>
      </ul>
      <p class="mt-4 text-slate-100/80">
        Si tu veux, on peut ajouter sur cette page une version <em>audio</em> (MP3) ou une transcription syllabe par syllabe
        adaptée aux enfants.
      </p>
    </section>

    <!-- 4. Pourquoi c’est important -->
    <section id="pourquoi" class="mb-10">
      <h2 class="text-2xl font-bold mb-3">4. Pourquoi c’est important&nbsp;?</h2>
      <p class="mb-3 text-slate-100/90">
        Le karaté forme le corps, mais aussi l’attitude. Le Dojo Kun sert de boussole&nbsp;:
      </p>
      <ul class="space-y-2 text-slate-100/90">
        <li><strong>Au dojo</strong> : respect, sécurité, entraide, progression sereine.</li>
        <li><strong>À l’école / au travail</strong> : effort régulier, honnêteté, maîtrise de soi.</li>
        <li><strong>Dans la vie</strong> : confiance calme plutôt que agressivité, discipline plutôt que excuses.</li>
      </ul>
    </section>
    ...
    <section class="mt-12 mb-10">
      <div class="rounded-2xl border border-slate-800 bg-slate-900/60 px-6 py-6 md:px-8 md:py-8">
        <h2 class="text-xl md:text-2xl font-bold mb-3">
          Envie de découvrir le karaté Shotokan au KC Nalinnes&nbsp;?
        </h2>
        <p class="mb-4 text-slate-100/90">
          Le premier cours d’essai est gratuit, sans engagement. Viens découvrir l’ambiance du dojo et notre manière
