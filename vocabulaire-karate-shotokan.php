...
<body class="bg-slate-950 text-slate-100">
  ...
  <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 pt-20 md:pt-24">
    ...
    <p class="text-sm text-slate-400 mb-8">
      Une page pour les élèves du <strong>KC Nalinnes</strong> : apprendre à compter en japonais,
      retrouver les principaux mots entendus au dojo et réviser facilement à la maison.
    </p>

    <!-- 1. Compter en japonais -->
    <section id="compter" class="mb-10">
      <h2 class="text-2xl font-bold mb-3">1. Compter en japonais</h2>
      <p class="mb-3 text-slate-100/90">
        Au karaté, on compte souvent en japonais pour les exercices. Commence par les chiffres de 1 à 10,
        puis entraîne-toi à compter à voix haute pendant les échauffements ou à la maison.
      </p>
      ...
      <div class="mt-4 overflow-x-auto rounded-2xl border border-slate-800 bg-slate-900/60">
        <table class="min-w-full text-sm vocab-table">
          <thead class="border-b border-slate-800 text-left text-slate-100/80">
            <tr>
              <th>Nombre</th>
              <th>Japonais (rōmaji)</th>
              <th>Prononciation approximative</th>
            </tr>
          </thead>
          <tbody class="divide-y divide-slate-800">
            <tr><td>1</td><td><strong>ichi</strong></td><td>itchi</td></tr>
            <tr><td>2</td><td><strong>ni</strong></td><td>ni</td></tr>
            <tr><td>3</td><td><strong>san</strong></td><td>san</td></tr>
            <tr><td>4</td><td><strong>yon</strong> (ou <em>shi</em>)</td><td>yon</td></tr>
            <tr><td>5</td><td><strong>go</strong></td><td>go (comme « go ! »)</td></tr>
            <tr><td>6</td><td><strong>roku</strong></td><td>ro-ku</td></tr>
            <tr><td>7</td><td><strong>nana</strong> (ou <em>shichi</em>)</td><td>na-na</td></tr>
            <tr><td>8</td><td><strong>hachi</strong></td><td>ha-tchi</td></tr>
            <tr><td>9</td><td><strong>kyū</strong></td><td>kyou / kiu</td></tr>
            <tr><td>10</td><td><strong>jū</strong></td><td>djou</td></tr>
          </tbody>
        </table>
      </div>

      <p class="mt-4 text-slate-100/90">
        Au dojo, on entend parfois aussi&nbsp;:
      </p>

      <ul class="list-disc pl-6 space-y-1 text-slate-100/90">
        <li><strong>jū ichi</strong> (11) = 10 + 1</li>
        <li><strong>jū ni</strong> (12) = 10 + 2</li>
        <li><strong>nijū</strong> (20) = 2 × 10</li>
        <li><strong>san-jū</strong> (30) = 3 × 10</li>
      </ul>

      <p class="mt-4 text-slate-100/80">
        Astuce&nbsp;: commence par bien maîtriser 1 à 10. Ensuite, amuse-toi à compter en japonais
        en montant les escaliers, en faisant des pompes ou des abdos.
      </p>
    </section>

    <!-- 2. Commandes du dojo -->
    <section id="commandes" class="mb-10">
      <h2 class="text-2xl font-bold mb-3">2. Les commandes que tu entends au dojo</h2>
      <p class="mb-3 text-slate-100/90">
        Voici les mots japonais que l’on utilise souvent pendant les cours. Ils sont les mêmes
        pour les enfants, les ados et les adultes.
      </p>

      <div class="mt-4 grid gap-6 md:grid-cols-2">
        <div class="rounded-2xl border border-slate-800 bg-slate-900/60 p-4">
          <h3 class="text-lg font-semibold mb-2">Saluts et positions</h3>
          <ul class="space-y-2 text-slate-100/90">
            <li><strong>Rei</strong> — Salut</li>
            <li><strong>Seiza</strong> — Position à genoux</li>
            <li><strong>Mokuso</strong> — Petite méditation (yeux fermés, calme)</li>
            <li><strong>Yame</strong> — Arrête / stop</li>
            <li><strong>Hajime</strong> — Commence / allez, on y va</li>
            <li><strong>Matte</strong> — Attends / pause</li>
          </ul>
        </div>

        <div class="rounded-2xl border border-slate-800 bg-slate-900/60 p-4">
          <h3 class="text-lg font-semibold mb-2">Directions & repères</h3>
          <ul class="space-y-2 text-slate-100/90">
            <li><strong>Mae</strong> — Devant / vers l’avant</li>
            <li><strong>Ushiro</strong> — Derrière / vers l’arrière</li>
            <li><strong>Migi</strong> — Droite</li>
            <li><strong>Hidari</strong> — Gauche</li>
            <li><strong>Dojo</strong> — Salle d’entraînement</li>
            <li><strong>Sensei</strong> — Professeur</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <!-- 3. Positions de base -->
    <section id="positions" class="mb-10">
      <h2 class="text-2xl font-bold mb-3">3. Les positions (dachi)</h2>
      <p class="mb-3 text-slate-100/90">
        En Shotokan, les positions des jambes sont très importantes. En voici quelques-unes
        que tu entendras souvent.
      </p>
      ...
      <div class="mt-4 overflow-x-auto rounded-2xl border border-slate-800 bg-slate-900/60">
        <table class="min-w-full text-sm vocab-table">
          ...
          <tbody class="divide-y divide-slate-800">
            <tr>
              <td><strong>Zenkutsu-dachi</strong></td>
              <td>zen-koutsou-datchi</td>
              <td>Position de fente avant (jambe avant fléchie, jambe arrière tendue)</td>
            </tr>
            <tr>
              <td><strong>Kokutsu-dachi</strong></td>
              <td>ko-koutsou-datchi</td>
              <td>Position de fente arrière (poids du corps sur la jambe arrière)</td>
            </tr>
            <tr>
              <td><strong>Kiba-dachi</strong></td>
              <td>kiba-datchi</td>
              <td>Position du cavalier (jambes écartées, genoux fléchis)</td>
            </tr>
            <tr>
              <td><strong>Heisoku-dachi</strong></td>
              <td>hé-so-ku-datchi</td>
              <td>Position pieds serrés</td>
            </tr>
            <tr>
              <td><strong>Hachiji-dachi</strong></td>
              <td>ha-tchiji-datchi</td>
              <td>Position naturelle, pieds légèrement ouverts (position de départ)</td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    <section id="techniques" class="mb-10">
      <h2 class="text-2xl font-bold mb-3">4. Techniques de base (tsuki, uchi, geri, uke)</h2>
      <p class="mb-3 text-slate-100/90">
        Voici les noms des techniques que tu entends pendant les kihon et les kata.
        Tu peux t’entraîner à les réciter en même temps que les mouvements.
      </p>

      <div class="grid gap-6 md:grid-cols-2">
        <div class="rounded-2xl border border-slate-800 bg-slate-900/60 p-4">
          <h3 class="text-lg font-semibold mb-2">Coups de poing et frappes</h3>
          <ul class="space-y-2 text-slate-100/90">
            <li><strong>Oi-zuki</strong> — Coup de poing en avançant</li>
            <li><strong>Gyaku-zuki</strong> — Coup de poing du bras arrière</li>
            <li><strong>Tate-zuki</strong> — Coup de poing vertical</li>
            <li><strong>Uraken-uchi</strong> — Coup de revers du poing</li>
            <li><strong>Shuto-uchi</strong> — Coup de tranchant de la main</li>
          </ul>
        </div>

        <div class="rounded-2xl border border-slate-800 bg-slate-900/60 p-4">
          <h3 class="text-lg font-semibold mb-2">Blocages & coups de pied</h3>
          <ul class="space-y-2 text-slate-100/90">
            <li><strong>Gedan-barai</strong> — Blocage bas</li>
            <li><strong>Age-uke</strong> — Blocage montant (en haut)</li>
            <li><strong>Soto-uke</strong> — Blocage vers l’extérieur</li>
            <li><strong>Uchi-uke</strong> — Blocage vers l’intérieur</li>
            <li><strong>Mae-geri</strong> — Coup de pied de face</li>
            <li><strong>Mawashi-geri</strong> — Coup de pied circulaire</li>
            <li><strong>Yoko-geri</strong> — Coup de pied de côté</li>
          </ul>
        </div>
      </div>
    </section>

    <!-- 5. Mini-fiche de révision -->
    <section id="revision" class="mt-12 mb-10">
      <div class="rounded-2xl border border-slate-800 bg-slate-900/60 px-6 py-6 md:px-8 md:py-8">
        ...
        <p class="mb-4 text-slate-100/90">
          Avant chaque cours, tu peux relire cette petite fiche&nbsp;:
        </p>
        <ul class="list-disc pl-6 space-y-2 text-slate-100/90">
          <li><strong>Compter de 1 à 10</strong> : ichi, ni, san, yon, go, roku, nana, hachi, kyū, jū.</li>
          <li><strong>Saluts</strong> : rei, seiza, mokuso, hajime, yame.</li>
          <li><strong>Positions</strong> : zenkutsu-dachi, kokutsu-dachi, kiba-dachi.</li>
          <li><strong>Techniques</strong> : oi-zuki, gyaku-zuki, gedan-barai, age-uke, mae-geri…</li>
        </ul>
        <p class="mt-4 text-slate-100/80">
          L’objectif n’est pas d’être parfait tout de suite, mais de reconnaître ces mots et de
          te sentir de plus en plus à l’aise quand tu les entends au dojo.
        </p>
      </div>
    </section>
